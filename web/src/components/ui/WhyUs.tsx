const FEATURES = [
  {
    ...
    description: 'We compare prices across hundreds of suppliers to find you the lowest rates.',
    icon: (
  ...
  },
  {
    ...
    description: 'Get rewarded for every booking. Redeem points for discounts on future trips.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
