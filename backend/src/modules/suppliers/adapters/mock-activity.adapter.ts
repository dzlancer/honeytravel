...
export class MockActivityAdapter extends ActivityAdapter {
  ...
  initialize(credentials: Record<string, string>): void {
    this.logger.log(`MockActivityAdapter initialized for supplier: ${this.supplierId}`);
  }

  private static readonly ACTIVITY_IDS = {
  ...
  private getMockActivities(): Activity[] {
    return [
      ...
      },
      {
        ...
        location: { lat: 36.7853, lng: 3.0600 },
        duration: '3 hours',
      ...
      },
      {
        ...
        location: { lat: 25.0584, lng: 8.0000 },
        duration: '2 days',
        ...
        avgRating: 4.7,
        reviewCount: 89,
        schedule: ['Mon & Wed departures, March-November'],
